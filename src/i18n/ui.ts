...
export const ui = {
  zh: {
    ...
    'about.intro2': 'INFJ。喜欢研究提高效率的自动化工具，也喜欢创造有趣的产品。',
    'about.secPath': '经历',
    'about.secContact': '联系',
    'notes.title': '随记',
  ...
  en: {
    ...
    'about.intro2': 'INFJ. I enjoy exploring automation tools that make life more efficient, and creating interesting products.',
    'about.secPath': 'Path',
