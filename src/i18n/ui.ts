...
export const ui = {
  zh: {
    ...
    'about.title2': '自由表达。',
    'about.intro1': '我是严树成，INFJ，现居南京，在华为做解决方案设计师。我关心复杂系统如何变成清晰、自然的体验。',
    'about.intro2': '喜欢研究自动化工具，也喜欢把想法做成有趣的产品。',
    'about.secPath': '经历',
    'about.secContact': '联系',
    'notes.title': '随记',
  ...
  en: {
    ...
    'about.intro1': "I'm Shucheng Yan, an INFJ based in Nanjing, working as a solution designer at Huawei. I care about turning complex systems into clear, natural experiences.",
    'about.intro2': 'I enjoy exploring automation tools and turning ideas into interesting products.',
    'about.secPath': 'Path',
