...
export const ui = {
  zh: {
    ...
    'about.title2': '自由表达。',
    'about.intro1': '我是严树成，INFJ，现居南京。',
    'about.intro2': '喜欢把想法做成有趣的产品。',
    'about.secPath': '经历',
    'about.secContact': '联系',
    'notes.title': '随记',
  ...
  en: {
    ...
    'a11y.home': 'Home',
    'a11y.menu': 'Site menu',
    'a11y.primary': 'Primary navigation',
    ...
    'about.intro1': "I'm Shucheng Yan, an INFJ based in Nanjing.",
    'about.intro2': 'I enjoy turning ideas into interesting products.',
    'about.secPath': 'Path',
