...
export const ui = {
  zh: {
    ...
    'foot.about': '关于',
    'foot.contact': '联系',
    'foot.contactKicker': '联系',
    'foot.contactTitle': '有话想聊，写信给我。',
    'foot.email': '邮件',
    'foot.wechat': '微信',
    'foot.top': '返回顶部',
    ...
    'about.title2': '自由表达。',
    'about.intro1': '我是严树成，现居南京，在华为做零售产品管理。我关心复杂系统如何变成清晰、自然的体验。',
    'about.intro2': 'INFJ。喜欢研究自动化工具，也喜欢把想法做成有趣的产品。',
    'about.secPath': '经历',
    'about.secContact': '联系',
    'notes.title': '随记',
  ...
  en: {
    ...
    'foot.contactKicker': 'Contact',
    'foot.contactTitle': 'Have something in mind? Write to me.',
    'foot.email': 'Email',
    'foot.wechat': 'WeChat',
    ...
    'about.intro1': "I'm Shucheng Yan, based in Nanjing, working on retail product management at Huawei. I care about turning complex systems into clear, natural experiences.",
    'about.intro2': 'INFJ. I enjoy exploring automation tools and turning ideas into interesting products.',
    'about.secPath': 'Path',
